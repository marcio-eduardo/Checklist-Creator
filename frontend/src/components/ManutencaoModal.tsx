...
const ManutencaoModal: React.FC<Props> = ({ isOpen, onClose, onSave, currentValue }) => {
    ...
    const handleSave = () => {
        let summaryParts = [];
        if (data.pastaTermica) summaryParts.push("Troca da Pasta Térmica");
        if (data.limpezaRam) summaryParts.push("Limpeza Conectores RAM");
        if (data.limpezaFan) summaryParts.push("Limpeza CPU Fan");
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            >
                <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-xl">
                    <h3 className="text-lg font-bold text-gray-800 text-center">Manutenção Preventiva</h3>
                </div>
                    ...
                    <div className="text-left space-y-4 px-2">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                checked={data.pastaTermica}
                                onChange={(e) => setData({ ...data, pastaTermica: e.target.checked })}
                            />
                            <label htmlFor="pasta" className="ml-3 block text-sm font-medium text-gray-900 cursor-pointer">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                type="checkbox"
                                className="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded cursor-pointer"
                                checked={data.limpezaRam}
                                onChange={(e) => setData({ ...data, limpezaRam: e.target.checked })}
                            />
                            <label htmlFor="ram" className="ml-3 block text-sm font-medium text-gray-900 cursor-pointer">
                                Limpeza nos Conectores da Memória RAM
                            </label>
                        </div>
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                type="checkbox"
                                className="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded cursor-pointer"
                                checked={data.limpezaFan}
                                onChange={(e) => setData({ ...data, limpezaFan: e.target.checked })}
                            />
                            <label htmlFor="fan" className="ml-3 block text-sm font-medium text-gray-900 cursor-pointer">
                                Limpeza do CPU Fan
                            </label>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="outroManutencao" className="ml-3 block text-sm font-medium text-gray-900 cursor-pointer">
                                    Outro
                                </label>
                            </div>
                            ...
                            {data.outro && (
                                <div className="mt-3 ml-8 animate-fade-in-down">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: Limpeza externa..."
                                        autoFocus
                                    />
                                </div>
                            )}
